...
This is the README for the One-Shot version of this. This folder is for doing this in two runs. The first creates the taxonomy and the second then classifies. Using this version you need to run each independently.
