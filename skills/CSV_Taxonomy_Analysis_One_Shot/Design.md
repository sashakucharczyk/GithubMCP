...
* `skills/CSV_Taxonomy_Analysis_One_Shot/taxonomy.csv`
  or
* `skills/CSV_Taxonomy_Analysis_One_Shot/taxonomy.md`
...
* Input: original CSV, e.g. `skills/CSV_Taxonomy_Analysis_One_Shot/raw_input.csv`
* Output: `skills/CSV_Taxonomy_Analysis_One_Shot/labeled_output.csv`
