...
INPUT_PATH = "skills/CSV_Taxonomy_Analysis_One_Shot/raw_input.csv"
TAXONOMY_PATH = "skills/CSV_Taxonomy_Analysis_One_Shot/taxonomy.csv"
LABELED_OUTPUT_PATH = "skills/CSV_Taxonomy_Analysis_One_Shot/labeled_output.csv"
