...
**Input CSV (read-only)**  
- Path: `skills/CSV_Taxonomy_Analysis_One_Shot/raw_input.csv`  
- Contains at least:
...
1. **Taxonomy definition**
   ...
   - Path: `skills/CSV_Taxonomy_Analysis_One_Shot/taxonomy.csv`
   - Columns:
     - `Category ID`  
...
2. **Labeled dataset**
   ...
   - Path: `skills/CSV_Taxonomy_Analysis_One_Shot/labeled_output.csv`
   - Must:
...
1. `skills/CSV_Taxonomy_Analysis_One_Shot/taxonomy.csv`  
...
2. `skills/CSV_Taxonomy_Analysis_One_Shot/labeled_output.csv`  
